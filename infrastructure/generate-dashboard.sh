...
<body>
    ...
    <div class="grid">
        ...
        <div class="card">
            ...
            {"<div class='metric'>" + str(gov_data['accessibility_score']) + "%</div><p>Accessibility</p>" if gov_data else "<p>No data</p>"}
            {"<div class='metric'>" + str(gov_data['localization_score']) + "%</div><p>Localization</p>" if gov_data else ""}
        </div>
