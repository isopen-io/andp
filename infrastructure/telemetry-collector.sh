...
ANDP_METRICS_DIR="${ANDP_CONFIG_DIR:-.andp}/metrics" python3 - << 'EOF_PY'
import json
import os
import platform
import secrets
...
# The .andp namespace, like every other producer. Hardcoding "metrics" here left
# the dashboard reading .andp/metrics/ while this wrote elsewhere.
METRICS_DIR = os.environ.get("ANDP_METRICS_DIR", ".andp/metrics")
